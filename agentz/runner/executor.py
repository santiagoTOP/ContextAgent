...
class AgentExecutor:
    """[Backward Compatibility] Wrapper around agent_step function.
    
    Use the standalone agent_step() function directly instead.
    ...
    async def agent_step(
        ...
        **kwargs
        ...
        """Delegate to standalone agent_step function.
        
        Args:
            agent: The agent to run
            instructions: Instructions/prompt for the agent
            **kwargs: Additional arguments passed to agent_step()
